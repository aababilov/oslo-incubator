...
class DeprecatedAuthPlugin(BaseAuthPlugin):
    ...
    Old auth systems only define two entry points: openstack.common.apiclient.auth_url
    and openstack.common.apiclient.authenticate. This class will load those entry points
